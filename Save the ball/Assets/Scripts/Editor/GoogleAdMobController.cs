    ...
    public class GoogleAdMobController : MonoBehaviour
    {
        ...
        public void RequestAndLoadRewardedInterstitialAd()
        {
            ...
            RewardedInterstitialAd.LoadAd(adUnitId, CreateAdRequest(), (rewardedInterstitialAd, error) =>
            {
                ...
                MobileAdsEventExecutor.ExecuteInUpdate(() => { statusText.text = "RewardedInterstitialAd loaded"; });
        ...
        public void OpenAdInspector()
        {
            ...
            MobileAds.OpenAdInspector((error) =>
            {
                ...
                {
                    MobileAdsEventExecutor.ExecuteInUpdate(() => { statusText.text = "Ad Inspector closed."; });
                }
            });
        }
